...
import { calculateSupplierType, riskLevelColor, SupplierTypeCode } from "@/lib/risk-assessment"
    ...
    <div className="p-6 bg-white rounded shadow">
      ...
      <div className="mb-6 p-4 border rounded bg-gray-50">
        <div className="flex items-center justify-between">
          ...
          <div className={`px-3 py-1 rounded-full text-white ${formData.supplierType && riskLevelColor[formData.supplierType as SupplierTypeCode] || "bg-gray-500"}`}>
